<script lang= "ts">
	...
	onMount(() => { (async () => {
		...
		const g = await loader.loadAsync('src/routes/(private)/game/public/pop.glb');
		...
		const gltf = await loader.loadAsync('src/routes/(private)/game/public/pir.glb');
		...
		const gl = await loader.loadAsync('src/routes/(private)/game/public/sty.glb');
		...
		const bouee = await loader.loadAsync('src/routes/(private)/game/public/bue.glb');
