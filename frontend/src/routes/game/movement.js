...
const gltf = await loader.loadAsync('pop.glb');
...
const gl = await loader.loadAsync('sty.glb');
...
const bouee = await loader.loadAsync('bue.glb');
...
const textur = new THREE.TextureLoader().load( "f.png" );
